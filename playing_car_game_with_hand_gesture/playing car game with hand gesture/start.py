    ...
    while cap.isOpened():
        ...
        if len(co) == 2:
            ...
            if co[0][0] > co[1][0] and co[0][1] > co[1][1] and co[0][1] - co[1][1] > 65:
                ...
                keyinput.release_key('K_DOWN')
                keyinput.release_key('K_RIGHT')
                keyinput.press_key('K_LEFT')
                ...
                # print("Turn left.")
                keyinput.release_key('K_DOWN')
                keyinput.release_key('K_LEFT')
                keyinput.press_key('K_RIGHT')
                cv2.putText(image, "Turn left", (50, 50), font,
                            0.8, (0, 255, 0), 2, cv2.LINE_AA)
                cv2.line(image, (int(xbp), int(ybp)),
                         (int(xm), int(ym)), (195, 255, 62), 20)
        ...
        if len(co) == 1:
            ...
            keyinput.release_key('K_LEFT')
            keyinput.release_key('K_RIGHT')
            keyinput.release_key('K_UP')
            keyinput.press_key('K_DOWN')
